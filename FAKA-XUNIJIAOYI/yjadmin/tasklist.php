...
<div class="right" id="right">
 <ul class="wz">
 <li class="l1">当前位置：后台首页 - <strong>任务大厅</strong></li><li class="l2"></li>
 </ul>
 ...
 <ul class="typecon">
 <li class="l1">
 <a href="javascript:checkDEL(22,'yjcode_task')" class="a1">变更审核</a>
 ...
 <li class="l7">
 <a href="<?=$aurl?>">修改</a> | <a href="../task/view<?=$row[id]?>.html" target="_blank">预览</a>
 </li>
 </ul>
 <? }?>
 <?
