...
<div class="iright">
 ...
 <ul class="u1">
 <li class="cap"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网网站公告</a></li>
 ...
 <ul class="u2">
 <li class="l1">会员 <strong><?=returncount("yjcode_user")?></strong> 位</li>
 <li class="l2">商品 <strong><?=returncount("yjcode_pro where zt=0 and ifxj=0")?></strong> 个</li>
 <li class="l3">交易 <strong><?=returncount("yjcode_order where (ddzt='wait' or ddzt='db' or ddzt='back' or ddzt='suc')")?></strong> 笔</li>
 <li class="l4">需求 <strong><?=returncount("yjcode_task where zt=0")?></strong> 条</li>
 <li class="l5">成交 <strong><?=sprintf("%.0f",returnsum("money1*num","yjcode_order where ddzt<>'backsuc' and ddzt<>'close'"))?></strong> 元</li>
...
<!--最新交易开始-->
<div class="newjy">
<span class="s1"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网最新交易</a></span>
<span class="s2"></span>
 <ul id="rolltxt">
...
<ul class="u1">
<li class="l1"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网限时特价</a></li>
...
<li class="l1">
<span class="djs" id="djs<?=$i?>">顺控源码</span>
...
<li class="l3<? if(1==$nj){?> l31<? }?>" id="lcap<?=$ni?>-<?=$nj?>" onMouseOver="lcapover(<?=$ni?>,<?=$nj?>)"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网精品推荐</a></li>
<?
$ty2idarr=array();
...
<div class="gdmain">
<ul class="u1"><li class="l1"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网热门评论</a></li><li class="l2"></li></ul>
...
<ul class="u2">
<li class="l1"><a href="http://www.5ufxw.com/" target="_blank">无忧分享网最新入驻商家</a></li>
...
<!--商家E-->
 ...
 <div class="bolink">
 <ul class="u1">
 <li class="l1 fontyh"><?=webname?><a href="http://www.5ufxw.com/" target="_blank">无忧分享网合作伙伴</a></li>
 <li class="l2">
 ...
 <ul class="u1">
 <li class="l1 fontyh"><?=webname?><a href="http://www.5ufxw.com/" target="_blank">无忧分享网友情链接</a></li>
 <li class="l3">
