<?php
/* Smarty version 3.1.46, created on 2025-04-07 22:35:12
  from '/www/wwwroot/webfaka/app/View/Admin/Store/Store.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_67f3e2a05d5933_80435220',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c1aa3f53e4dcf1a1c7747d52c060529701a00278' => 
    array (
      0 => '/www/wwwroot/webfaka/app/View/Admin/Store/Store.html',
      1 => 1743848191,
      2 => 'file',
    ),
  ),
...
function content_67f3e2a05d5933_80435220 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <div class="card-toolbar">
                        ...
                        <button class="btn btn-sm btn-light-primary me-3 bind-pro" style="display: none;"><i
                                    class="fas fa-mask"></i> 绑定专业版/企业版
                        </button>
                    </div>
                </div>
                <!--end::Header-->
...
>
    ...
    $(function () {
        layui.use(['hex', 'form'], function () {
                ...
                if (userLevel == -1) {
                    ...
                    items.push({
                        ...
                        content: "<div style='padding: 20px;'><b style='color: #109b81;margin-bottom: 10px;display: block;'>说明：本程序基于MIT开源协议进行开源，项目开源地址：<a href='https://github.com/lizhipay/acg-faka' target='_blank'>https://github.com/lizhipay/acg-faka</a>，所以是完全免费的，这里的专业版或企业版仅仅是针对应用商店付费插件和技术服务而产生的。</b>" +
                            ...
                            "<p>5.企业版专属售后群</p>" +
                            "</div>" +
                            "<p style='margin-bottom: 15px;'><span class='badge badge-light-danger'>价格：" + purchasePrice.enterprise + "/永久</span><span style='text-decoration: line-through;'>(原价:898)</span> <span style='font-size: 12px;'>即将恢复原价</span></p>" +
                    ...
                    items.push({
                        ...
                        content: "<div style='padding: 20px;'><b style='color: #109b81;margin-bottom: 10px;display: block;'>说明：本程序基于MIT开源协议进行开源，项目开源地址：<a href='https://github.com/lizhipay/acg-faka' target='_blank'>https://github.com/lizhipay/acg-faka</a>，所以是完全免费的，这里的专业版或企业版仅仅是针对应用商店付费插件和技术服务而产生的。</b>" +
                            ...
                            "<p>5.7×12小时专属技术响应</p>" +
                            "<p>6.企业版专用售后QQ群</p>" +
                            "<p style='color: #0200ff;font-weight: bold'>7.新V4.0版本抢先体验</p>" +
                            "<p style='color: #0200ff;font-weight: bold'>8.V3(当前程序)企业版无亏损转移到V4.0</p>" +
                            "</div>" +
                            "<p style='margin-bottom: 15px;'><span class='badge badge-light-danger'>价格：" + (purchasePrice.enterprise-purchasePrice.pro) + "/永久</span><span style='text-decoration: line-through;'>(原价:898)</span> <span style='font-size: 12px;'>即将恢复原价</span></p>" +
                            "<p><span class='badge badge-primary purchase-btn' data-type='2' data-pay='0'>支付宝</span> <span class='badge badge-success purchase-btn' data-type='2' data-pay='1'>微信支付</span></p>" +
                            "</div>"
                    });
                }
            ...
            let bindLevel = function () {
                layer.open({
                    type: 1,
                    shade: false,
                    title: false,
                    area: cao.isPc() ? "712px" : ["100%", "100%"],
                    content: '<div style="padding: 30px;"><table id="purchaseLevelRecords"></table></div>',
                    success: function () {
                        $("#purchaseLevelRecords").bootstrapTable({
                            url: '/admin/api/app/levels',//请求的url地址
                            method: "post",//请求方式
                            ...
                            columns: [
                                {checkbox: true},
                                {
                                    field: 'level', title: '用户组',
                                    formatter: function (val, item) {
                                        if (item.level == 0) {
                                            return '<span class="badge badge-light-primary">专业版</span>';
                                        }
                                        return '<span class="badge badge-light-success">企业版</span>';
                                    }
                                },
                                {
                                    field: 'server_ip',
                    ...
                    btn: ["解绑授权至本机器"],
                    yes: () => {
                        let data = cao.listObjectToArray($("#purchaseLevelRecords").bootstrapTable('getSelections'));
                        let authId = data[0];
                        if (authId > 0) {
                            layer.confirm('您正在进行指纹授权解绑操作，解绑后，该用户组将在原站点授权失效，是否继续？', {
                                btn: ['立即解绑', '取消'],
                                title: "解绑提示"
                            }, function () {
                                let layIndex = layer.load(1, {shade: [0.3, '#fff']});
                                $.post('/admin/api/app/bindLevel', {
                                    auth_id: authId
                                }, res => {
                                    layer.close(layIndex);
                                    if (res.code == 200) {
