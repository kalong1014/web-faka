<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/plugin/shopdiy.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                            ...
                            <div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-auto">
                                        <button  onclick="$.x_show('自定义素材', '<?php echo url('plugin/shopdiyThemeEdit'); ?>', 550)" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true"><i class="bx bx-plus mr-1"></i>自定义素材</button>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group btn-group-sm " role="group" aria-label="Basic group">
                                                        ...
                                                        <?php if($v['user_id']==$_user['id']): ?>
                                                        <button onclick="$.x_show('编辑', '<?php echo url('plugin/shopdiyThemeEdit',['id'=>$v['id']]); ?>', 550)" class="btn btn-light waves-effect text-primary" role="button" aria-pressed="true">编辑</button>
