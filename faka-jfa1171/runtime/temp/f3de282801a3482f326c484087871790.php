<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/charts/money.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                ...
                                <form class="form-inline" role="form" action="" method="get">
                                    ...
                                    <div class="form-group ml-1">
                                        <input class="form-control"   type="text" name="trade_no" value="<?php echo \think\Request::instance()->get('trade_no'); ?>" placeholder="请输入订单编号">
                                    </div>
                                    <div class="form-group ml-1">
                        ...
                        <div class="row">
                            <div class="col-sm-auto">
                                <span class="badge badge-soft-primary font-size-14 my-2 px-2 py-2">总收入：<?php echo $total_price; ?></span>
                            </div>
                            <div class="col-sm-auto">
                                <span class="badge badge-soft-success font-size-14 my-2  px-2 py-2">总成本：<?php echo $total_cost_price; ?></span>
                            </div>
                            <div class="col-sm-auto">
                                <span class="badge badge-soft-success font-size-14 my-2  px-2 py-2">总利润：<?php echo $total_profit; ?></span>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><a href="/orderquery?orderid=<?php echo $v['trade_no']; ?>" target="_blank"><?php echo $v['trade_no']; ?></a></th>
                                        <td>
