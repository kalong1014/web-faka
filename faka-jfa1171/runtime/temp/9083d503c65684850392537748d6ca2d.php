<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/www.811192.xyz/application/templates/pc/admin/default/login/index.html";i:1744477098;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        ...
        <!-- Stylesheet
        ========================= -->
        <link rel="stylesheet" href="/static/admin/login/bootstrap.min.css"/>
        <link rel="stylesheet" href="/static/admin/login/login_new.css"/>
        <!-- Colors Css -->
    </head>
    <body>
                ...
                <div class="row no-gutters min-vh-100 py-5"> 
                    ...
                    <div class="col-lg-7 shadow-lg">
                        <div class="hero-wrap d-flex align-items-center rounded-lg rounded-right-0 h-100">
                            ...
                            <div class="hero-bg hero-bg-scroll" style="background-image:url('/static/admin/login/login-bg.jpg');"></div>
                            <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
                                <div class="row no-gutters">
                                    <div class="col-10 col-lg-10 mx-auto">
                                        <div class="logo mt-5 mb-5 mb-lg-0"> <a href="index.html" title="Oxyy"><img src="<?php echo sysconf('site_logo'); ?>" alt="Oxyy"></a> </div>
                                    </div>
                                </div>
                                <div class="row no-gutters my-auto">
                                    <div class="col-10 col-lg-10 mx-auto">
                                        <h1 class="text-11 text-white mb-3"><?php echo sysconf('site_desc'); ?></h1><br>
                        ...
                        <div class="container my-auto py-5">
                            <div class="row">
                                <div class="col-11 col-lg-10 mx-auto">
                                    <h3 class="text-white text-center mb-4"><?php echo sysconf('app_name'); ?>后台登录</h3>

                                    <form id="loginForm" class="form-dark"  data-time="0.001" data-auto="true" method="post">
                                        <div class="form-group">
                                            <label class="text-light" for="username">用户名/手机号</label>
                                            <input type="text" class="form-control" name="username" autofocus="autofocus" autocomplete="off" id="username" required placeholder="请输入用户名/手机号码">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-light" for="password">密码</label>
                                            <input type="password" class="form-control" name="password" id="password" required placeholder="请输入密码">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-light" for="code">验证码</label>
                                            <div class="input-group">
                                                <input  name="code" id="code" class="form-control col-lg-8" required="" type="text" placeholder="请输入验证码" autocomplete="off">
                                                <img style="font-size:16px;padding:0px" src="<?php echo url('admin/login/verifycode',['t'=>time()]); ?>" class="form-control col-lg-4" id="vercodeImg"  onclick="this.src = '<?php echo url('admin/login/verifycode'); ?>?d=' + Math.random();" title="点击刷新验证码">      
                                            </div>
                                        </div>
                                        <button class="btn btn-primary btn-block my-4" type="submit">立即登录</button>
                                    </form>

                                    <p class="text-2 text-center text-light mb-0"><?php echo sysconf('site_copy'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Script --> 
        <script src="/static/admin/login/jquery.min.js"></script> 
        <script src="/static/admin/login/bootstrap.bundle.min.js"></script> 
        <!-- Style Switcher --> 
        <script src="/static/admin/login/switcher.min.js"></script> 
        <script src="/static/admin/login/theme.js"></script>
