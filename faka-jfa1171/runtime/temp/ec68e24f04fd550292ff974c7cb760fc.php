<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/www/wwwroot/www.811192.xyz/application/templates/mobile/index/land3//order/query.html";i:1575945762;s:88:"/www/wwwroot/www.811192.xyz/application/templates/mobile/index/land3/default_header.html";i:1575947310;s:88:"/www/wwwroot/www.811192.xyz/application/templates/mobile/index/land3/default_footer.html";i:1575165824;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
...
<section class="box-zone">
    <div class="order_form">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation"
            <?php if ($querytype==1){?>class="active"
            <?php }?>><a href="#cache" aria-controls="cache" role="tab" data-toggle="tab"
                         data-index="1">浏览器缓存查卡密</a></li>
            <li role="presentation"
            <?php if ($querytype==2){?>class="active"
            <?php }?>><a href="#trade" aria-controls="trade" role="tab" data-toggle="tab"
                         data-index="2">通过订单编号查询</a></li>
            <li role="presentation"
            <?php if ($querytype==3){?>class="active"
            <?php }?>><a href="#contract" aria-controls="contract" role="tab" data-toggle="tab"
                         data-index="3">通过联系方式查询</a></li>
        </ul>

        <!-- Tab panes -->
        <div class="tab-content">
            <div role="tabpanel" id="cache"
            <?php if ($querytype==1){?>class="tab-pane active"
            <?php }?> class="tab-pane">
            <div class="search_box nb w10">
                <button onclick="orderid_or_contact()">查 询</button>
            </div>
        </div>
        <div role="tabpanel" id="trade"
        <?php if ($querytype==2){?>class="tab-pane active"
        <?php }?> class="tab-pane">
    ...
    <div role="tabpanel" id="contract"
    <?php if ($querytype==3){?>class="tab-pane active"
    <?php }?> class="tab-pane">
    <div class="search_box">
        <!-- <form action=""> -->
        <i class="iconfont icon-sousuo"></i>
    ...
    <div class="main_box">
        ...
        <p>卖家QQ：<b><a target="_blank" href="//wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $order['user']['qq']; ?>&amp;site=qq&amp;menu=yes"><?php echo $order['user']['qq']; ?></a></b>
        </p>
        <?php if(isset($canComplaint) && $canComplaint): ?>
        <p><a style="padding:5px 8px;background-color:#678cf7;color:white" href="/complaint?trade_no=<?php echo $order['trade_no']; ?>" target="_blank">订单投诉</a>
		<a style="padding:5px 8px;background-color:#678cf7;color:white" href="index/order/dckm?trade_no=<?php echo $order['trade_no']; ?>" target="_blank">导出卡密</a></p>
        <?php endif; ?>
