<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/www.811192.xyz/application/templates/pc/index/land3//user/forget_password.html";i:1681997716;}*/ ?>
  ...
  <div class="container">
    ...
    <div class="cs-prifile_wrap">
      <div class="cs-profile_left">
        <div class="cs-profile_sidebar cs-white_bg cs-box_shadow">
          <div class="cs-profile_info">
            ...
            <h3 class="cs-profile_title">CoCo云寄售</h3>
          ...
          <ul class="cs-profile_nav cs-mp0">
            ...
            <li>
              <a href="login/retpwd" class="active">
      ...
      <div class="cs-profile_right">
        <div class="cs-height_30 cs-height_lg_30"></div>
        <h2 class="cs-section_heading cs-style1">平台商户找回密码</h2>
        <div class="cs-height_25 cs-height_lg_25"></div>
        <form class="row" id="auth-form" method="post">
          ...
          <div class="col-lg-6">
            ...
            <span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                ...
                <span>手机号</span> 
                <input type="text"  name="mobile" autofocus="autofocus" autocomplete="off" id="mobile" required placeholder="请输入手机号">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>新密码</span> 
                <input type="password"  name="password" autofocus="autofocus" autocomplete="off" id="password" required placeholder="请输入密码">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>确认密码</span> 
                <input type="password"  name="password_confirm" autofocus="autofocus" autocomplete="off" id="password_confirm" required placeholder="确认新密码">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>手机短信</span> 
                <input  name="code" id="code" required type="text" placeholder="请输入短信验证码" autocomplete="off">
				<button class="cs-btn cs-style1" type="button" value="获取验证码"  id="send" >
                <span>去获取</span>                
              </button>
              </span>
            </span>
          ...
          <div class="col-lg-12">
            ...
            <button class="cs-btn cs-style1 cs-btn_lg" type="button"><span>提 交 申 请</span></button>
          </div>
        </form>
      </div>
    </div>
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="cs-footer_widget">
            ...
            <form class="cs-footer_newsletter">
              <input type="text" placeholder="1601349@qq.com" class="cs-newsletter_input">
  ...
  <script src="/static/merchant/login/jquery.min.js"></script> 
        ...
        <script>
            ...
            function send_sms() {
                ...
                $('.layui-layer-prompt .layui-layer-content').prepend($('<img style="cursor:pointer;height: 60px;" id="chkcode_img" src="https://www.611qk.com/index/user/verifycode.html?t=1681997418" onclick="javascript:this.src=\'/index/user/verifycode\'+\'?time=\'+Math.random()">'))
            }

            $('button').click(function () {
                if (checker()) {
                    var data = $('#auth-form').serialize()
                    $.post("https://www.611qk.com/index/user/doforgetpassword.html", data, function (res) {
                        if (res.code == 1) {
