<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/message/index.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><?php if($v['from_id']==0): ?><span class="badge badge-danger">系统</span><?php else: ?><?php echo $v['fromUser']['username']; endif; ?></th>
...
<script>
    function change_status(obj, id)
    {
        ...
        $.post("<?php echo url('message/changeStatus'); ?>", {
            id: id,
            status: status
        }, function (res) {
            if (res.code != 1) {
