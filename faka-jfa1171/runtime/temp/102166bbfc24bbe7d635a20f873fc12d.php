<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/goods_coupon/trash.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        var loading = layer.load(1, {shade: [0.1, '#fff']});
                        $.post("<?php echo url('goods_coupon/restore'); ?>", {
                            id: id
                        }, function (res) {
                            if (res.code != 1) {
                                $.alert(res.msg);
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        var loading = layer.load(1, {shade: [0.1, '#fff']});
                        $.post("<?php echo url('goods_coupon/batch_restore'); ?>", {
                            ids: ids
                        }, function (res) {
                            if (res.code != 1) {
                                $.alert(res.msg);
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        var loading = layer.load(1, {shade: [0.1, '#fff']});
                        $.post("<?php echo url('goods_card/trash_clear'); ?>", {}, function (res) {
                            if (res.code != 0) {
                                $.alert('清空失败');
                            } else {
                                $.alert('清空成功');
