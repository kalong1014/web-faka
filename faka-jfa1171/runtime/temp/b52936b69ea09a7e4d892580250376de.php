<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/www.811192.xyz/application/templates/pc/index/land3//index/contact.html";i:1681998106;}*/ ?>
...
<body class="cs-dark">
  ...
  <div class="container">
        ...
        <div class="cs-contact_card_wrap">
          <div class="cs-contact_card">
            <div class="cs-contact_info text-center">
              ...
              <p class="cs-contact_text">客服QQ：<?php echo sysconf('site_info_qq'); ?></p>
            </div>
            <div class="cs-contact_info text-center">
              <div class="cs-contact_icon">
              ...
              <p class="cs-contact_text">联系邮箱：<?php echo sysconf('site_info_email'); ?></p>
            </div>
            <div class="cs-contact_info text-center">
              <div class="cs-contact_icon">
    ...
    <div class="cs-cta cs-style2 text-center cs-accent_bg">
      ...
      <div class="cs-cta_subtitle cs-white_color_8"><?php echo sysconf('site_name'); ?>打破了传统软件注册码交易网站几年来一成不变的局面，我们将引领软件注册码交易过程的个性化、自动化、工具 化等。作为业内最善于创新的网站，力争成为行业的佼佼者。</div>
