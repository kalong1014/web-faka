<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/www.811192.xyz/application/templates/pc/index/land3//index/news.html";i:1681672154;}*/ ?>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>新闻动态 - <?php echo sysconf('site_name'); ?></title>
...
<div id="wrapper">
<div id="page" class="clearfix"><header id="header_main" class="header_1 js-header">
...
<h1 class="heading text-center">新闻动态</h1>
</div>
...
<div class="col-lg-8 col-md-8 col-12">
    ...
    <!--结算公告内容-->
                        ...
                        <div class="sc-card-activity">
                            <article class="content">
                                <!--图片-->
                                <div class="media">
                                    
                                    <img src="/static/theme/coco/img/card-item-10.jpg" alt="">
                                <!--<figure class="post-img m0"><a href="/article/<?php echo $v['id']; ?>.html" class="w-100 d-block"><img src="<?php echo $v['title_img']; ?>" alt="" class="w-100 tran4s"></a></figure>-->
                                </div>
                                <!--图片-->
                                <div style="widht1:200px; line-height:30px;" class="blog-title"><a href="/article/<?php echo $v['id']; ?>.html"  class="blog-title"><h5><?php echo $v['title']; ?></h5></a>
                                <div class="status" ><h6>发布者：<font color="#5142FC">系统管理员</h6></font></div>
                                    <div class="post-tag"><a href="/article/<?php echo $v['id']; ?>.html">发布时间：</a><?php echo date('Y-m-d',$v['create_at']); ?></div>
                                </div>
                            </article>
...
<div class="btn-activity mg-t-40 center">
 <a href="#" class="sc-button loadmore fl-button pri-3"><span>查看更多</span></a>
</div>
</div>
...
<h3 class="title-widget">分类</h3>
<ul class="box-check">
<li><a href="/company/notice" class="box-widget-filter"><i class="icon-fl-sort-filled"></i>平台公告</a></li>
<li><a href="/company/settlement" class="box-widget-filter"><i class="icon-fl-heart-filled"></i>结算公告</a></li>
<li><a href="/company/news" class="box-widget-filter"><i class="icon-fl-buy"></i>新闻动态</a></li>
<li><a href="/company/faq" class="box-widget-filter"><i class="icon-fl-discount"></i>常见问题</a></li>
