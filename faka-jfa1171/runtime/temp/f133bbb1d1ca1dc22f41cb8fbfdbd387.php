<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/invite_code/index.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-auto">
                                <a href="<?php echo url('invite_code/add'); ?>" class="pull-right btn btn-primary waves-effect waves-light"><i class='bx bx-plus mr-1'></i>生成邀请码</a>
                            </div>
                            ...
                            <div class="col-sm-auto">
                                ...
                                <form class="form-inline" role="form" action="" method="get">
                                    ...
                                    <div class="form-group ml-2">
                                        添加时间：<input class="form-control input-daterange-datepicker"  type="text" name="create_at" value="<?php echo urldecode(\think\Request::instance()->get('create_at')); ?>" placeholder="点击选择查询日期">
                                    </div>

                                    <div class="form-group ml-2">
                                        过期时间：<input class="form-control input-daterange-datepicker"  type="text" name="expire_at" value="<?php echo urldecode(\think\Request::instance()->get('expire_at')); ?>" placeholder="点击选择查询日期">
                                    </div>
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php switch($v['status']): case "0": ?><font class="text-dark">未使用</font><?php break; case "1": ?><font class="text-success">已使用</font><?php break; case "2": ?><font class="text-danger">已过期</font><?php break; endswitch; ?>
                                        </td>
                                        <td>
                                            <?php if($v['status']==1): ?>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                            <span class="badge badge-success"><?php echo $v['expire_days']; ?>天</span>
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        var loading = layer.load(1, {shade: [0.1, '#fff']});
                        $.post("<?php echo url('invite_code/del'); ?>", {
                            id: id
                        }, function (res) {
                            if (res.code != 1) {
                                $.alert(res.msg);
