<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/horizontal/goods_card/add.html";i:1646323578;s:82:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/horizontal/base.html";i:1646323578;}*/ ?>
<!doctype html>
<html lang="en">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select name="goods_id" class="form-control select2">
                                        ...
                                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(\think\Request::instance()->get('goods_id')==$v['id']): ?>selected<?php endif; ?>><?php echo $v['name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
