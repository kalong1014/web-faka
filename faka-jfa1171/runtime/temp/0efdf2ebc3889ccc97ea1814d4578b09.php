<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/user/link.html";i:1682347658;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
...
if (result == true) {
 event.preventDefault(); // 阻止链接的默认行为
  ...
  xhr.open('GET', '/sc.php?url=<?php echo $_user['link']; ?>', true);
  xhr.onload = function() {
  };
  xhr.send();
   location.reload();
  ...
  console.log("取消");
              ...
              xhr.open("GET", "/api.php?url=<?php echo $_user['link']; ?>");
              xhr.onload = function() {
               if (xhr.status === 200) {
