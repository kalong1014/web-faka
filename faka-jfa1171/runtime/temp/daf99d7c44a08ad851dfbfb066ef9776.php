<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/www.811192.xyz/application/templates/pc/admin/default/mlog/index.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/admin/default/content.html";i:1646323578;}*/ ?>
<div class="ibox">
...
<form class="layui-form layui-form-pane form-search" action="__SELF__" onsubmit="return false" method="get">
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="username" value="<?php echo (\think\Request::instance()->get('username') ?: ''); ?>" placeholder="请输入商户用户名" class="layui-input">
        </div>
    </div>
