<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/plugin/bgdata_core.html";i:1646323578;}*/ ?>
<!doctype html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
                    ...
                    <li>
                        <div class="boxall" style="height:100px">
                            <div class="navboxall">
                                ...
                                <a id="aloneshow" href="<?php echo url('plugin/bgdataCore'); ?>" style="position: absolute;top: 8px;right: 8px;color: #5a71b0;font-size: 10px;border: 1px solid #5a71b0;padding: 2px 2px;border-radius: 3px;" target="_blank">独立显示</a>
                            </div>
                        </div>
        ...
        <script>
            ...
            function ajax_url()
            {
                return "<?php echo url('plugin/bgdataCore'); ?>";
            }
        </script>

        <script type="text/javascript" src="/static/plugs/bgdata/merchant_main.js?v=2"></script>
    </body>
