<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/user/wechat.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if(sysconf("wechat_notify")==0): ?>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10">
                                <?php if($_user['openid']==''): ?>
                                <img src="<?php echo wxewm('bind_'.$_user['id']); ?>" width="150"/>
                                <?php else: ?>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div class="custom-control custom-switch custom-switch-md mb-3" dir="ltr">
                                    <input  onchange="change_status(this, 'wechat_signin_notify')" name="wechat_signin_notify" <?php if($_user['wechat_signin_notify']==1): ?>checked<?php endif; ?> type="checkbox" class="custom-control-input" id="customSwitchsizemd1">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div class="custom-control custom-switch custom-switch-md mb-3" dir="ltr">
                                    <input  onchange="change_status(this, 'wechat_signin_notify')" name="wechat_signin_notify" <?php if($_user['wechat_complaint_notify']==1): ?>checked<?php endif; ?> type="checkbox" class="custom-control-input" id="customSwitchsizemd2">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div class="custom-control custom-switch custom-switch-md mb-3" dir="ltr">
                                    <input  onchange="change_status(this, 'wechat_stock_notify')" name="wechat_stock_notify" <?php if($_user['wechat_stock_notify']==1): ?>checked<?php endif; ?> type="checkbox" class="custom-control-input" id="customSwitchsizemd3">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div class="custom-control custom-switch custom-switch-md mb-3" dir="ltr">
                                    <input  onchange="change_status(this, 'wechat_cash_notify')" name="wechat_cash_notify" <?php if($_user['wechat_cash_notify']==1): ?>checked<?php endif; ?> type="checkbox" class="custom-control-input" id="customSwitchsizemd4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-10 d-flex align-items-center">
                                <div class="custom-control custom-switch custom-switch-md mb-3" dir="ltr">
                                    <input  onchange="change_status(this, 'wechat_sell_notify')" name="wechat_sell_notify" <?php if($_user['wechat_sell_notify']==1): ?>checked<?php endif; ?> type="checkbox" class="custom-control-input" id="customSwitchsizemd5">
...
<script>
                                        function change_status(obj, option)
                                        {
                                            ...
                                            $.post("<?php echo url('user/editNotify'); ?>", {
                                                option: option,
                                                status: status
                                            }, function (res) {
                                                if (res.code != 1) {
                                            ...
                                            $.confirm({
                                                ...
                                                buttons: {
                                                    tryAgain: {
                                                        ...
                                                        action: function () {
                                                            var loading = layer.load(1, {shade: [0.1, '#fff']});
                                                            $.post("<?php echo url('user/unBindWechat'); ?>", {
                                                            }, function (res) {
                                                                if (res.code != 1) {
                                                                    $.alert("解绑失败");
                                                                } else {
...
<script>
    ...
    {
        $.ajax({
            url: "<?php echo url('user/checkBind'); ?>",
