<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/spread/rebate.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <div class="alert alert-info alert-dismissable">
                                    返利比例：<?php echo get_spread_rebate_rate($_user['id'])*100; ?>% | 已返利总额：<?php echo $_user->rebate; ?>元
                                </div>
                            </div>
                        </div>
