<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/wwwroot/www.811192.xyz/application/templates/mobile/shop/default//index.html";i:1646323578;s:81:"/www/wwwroot/www.811192.xyz/application/templates/mobile/shop/default/layout.html";i:1646323578;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<section class="category">
    ...
    <div class="category_list">
        ...
        <div style="cursor:pointer" class="category_box <?php if($k==0): ?>active<?php endif; ?>" data-cateid="<?php echo $v['id']; ?>">
            ...
            <div class="cate_name"><?php echo $v['name']; ?></div>
            <div class="cate_desc">包含<?php echo $v['count']; ?>种商品</div>
        </div>
        <?php endforeach; ?>
