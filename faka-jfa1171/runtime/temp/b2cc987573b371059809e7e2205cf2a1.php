<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/spread/index.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12">
                                <div class="alert alert-info" role="alert">
                                    推广链接： <span>__PUBLIC__/register?user_id=<?php echo $_user['id']; ?></span>&nbsp;&nbsp;
                                    <?php if(sysconf('spread_reward')==1): ?>使用邀请码或推广链接注册奖励<?php echo sysconf('spread_reward_money'); ?>元，<?php endif; ?>
                                    返利比例<?php echo get_spread_rebate_rate($_user['id'])*100; ?>%
                                </div>
                                <div class="alert alert-info" role="alert">
                                    推广二维码： <a href="<?php echo $spread_url; ?>" target="_blank" >查看</a>
                                </div>
