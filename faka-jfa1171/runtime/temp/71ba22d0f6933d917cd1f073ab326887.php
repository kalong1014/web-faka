<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/cross/supply_goods.html";i:1646323578;s:79:"/www/wwwroot/www.811192.xyz/application/templates/pc/merchant/default/base.html";i:1646323578;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
    <head>
        <meta charset="utf-8">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php switch($v['cross']['platform']): case "kaduoduo": ?><span class="badge badge-pill badge-success font-size-12">卡多多</span><?php break; case "kaduoduoapi": ?><span class="badge badge-pill badge-success font-size-12">卡多多API</span><?php break; case "taoka": ?><span class="badge badge-pill badge-success font-size-12">淘卡</span><?php break; case "taokaapi": ?><span class="badge badge-pill badge-success font-size-12">淘卡API</span><?php break; case "xinkashou": ?><span class="badge badge-pill badge-success font-size-12">新卡售</span><?php break; case "xingouka": ?><span class="badge badge-pill badge-success font-size-12">新购卡</span><?php break; case "xingoukaapi": ?><span class="badge badge-pill badge-success font-size-12">新购卡API</span><?php break; case "xinkagou": ?><span class="badge badge-pill badge-success font-size-12">新卡购</span><?php break; case "kayixiao": ?><span class="badge badge-pill badge-success font-size-12">卡易销</span><?php break; case "kayixin": ?><span class="badge badge-pill badge-success font-size-12">卡易信</span><?php break; case "ukashou": ?><span class="badge badge-pill badge-success font-size-12">U卡售</span><?php break; endswitch; ?>
                                            <?php echo $v['cross']['domain']; ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic group">
                                                <button  onclick="$.x_show('商品链接', '<?php echo url('cross/link',['id'=>$v['id']]); ?>', 560)"  class="btn btn-light waves-effect waves-light text-primary">链接</button>
                                                <a href="<?php echo url('cross/edit',['id'=>$v['id']]); ?>" class="btn btn-light waves-effect waves-light text-primary">编辑</a>
...
<script>
    ...
    function change_status(obj, id) {
        ...
        $.post("<?php echo url('cross/changeStatus'); ?>", {
            id: id,
            status: status
        }, function (res) {
            if (res.code != 1) {
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    action: function () {
                        var loading = layer.load(1, {shade: [0.1, '#fff']});
                        $.post("<?php echo url('cross/batch_del'); ?>", {
                            ids: ids
                        }, function (res) {
                            if (res.code != 1) {
                                $.alert("删除失败");
