<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/www.811192.xyz/application/templates/pc/index/land3//user/register.html";i:1681997954;}*/ ?>
...
<head>
  <!-- Meta Tags -->
        <meta charset="utf-8" />
        <title>用户登录 - <?php echo sysconf('site_name'); ?></title>
...
<body class="cs-dark">
  ...
  <div class="container">
    <div class="cs-cover_photo cs-bg" data-src="/moban/index5/maowang66/img/cover-photo.jpeg">
    ...
    <div class="cs-prifile_wrap">
      <div class="cs-profile_left">
        <div class="cs-profile_sidebar cs-white_bg cs-box_shadow">
          <div class="cs-profile_info">
            <div class="cs-profile_pic"><img src="/moban/index5/maowang66/picture/avatar_29.png" alt=""></div>
            <h3 class="cs-profile_title"><?php echo sysconf('site_name'); ?></h3>
            <div class="cs-name"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo sysconf('site_info_qq'); ?>&site=qq&menu=yes">客服QQ:<?php echo sysconf('site_info_qq'); ?></a></div>
            <ul class="cs-profile_meta cs-mp0">
              <li><a href="/company/contact">遇到问题请联系平台客服</a></li>
          ...
          <ul class="cs-profile_nav cs-mp0">
            ...
            <li>
              <a href="/">
                <svg width="19" height="18" viewbox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M13.7109 6L12.6534 7.0575L13.8384 8.25H7.71094V9.75H13.8384L12.6534 10.935L13.7109 12L16.7109 9L13.7109 6ZM4.71094 3.75H9.96094V2.25H4.71094C3.88594 2.25 3.21094 2.925 3.21094 3.75V14.25C3.21094 15.075 3.88594 15.75 4.71094 15.75H9.96094V14.25H4.71094V3.75Z" fill="currentColor"></path>
                </svg>              
                <span>平台首页</span>
              </a>
            </li>
      ...
      <div class="cs-profile_right">
        <div class="cs-height_30 cs-height_lg_30"></div>
        <h2 class="cs-section_heading cs-style1">平台商户注册</h2>
        <div class="cs-height_25 cs-height_lg_25"></div>
        <form class="row" method="post" action="/register/regsave" id="reg" name="reg">
          ...
          <div class="col-lg-6">
            ...
            <span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                ...
                <span>用户名</span> 
                <input id="newusername" name="reginfo[username]" type="text"  placeholder="请输入用户名" required="">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>手机号</span> 
                <input type="text" id="newmobile" name="reginfo[mobile]"  placeholder="请输入手机号"  required="">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>联系邮箱</span> 
                <input type="text" id="newemail" name="reginfo[email]"  placeholder="请输入邮箱"  required="">
              </span>
            </span>
            
            <?php if(sysconf('site_register_smscode_status')==1&&sysconf('site_register_code_type')=='sms'): ?>  
            <div class="cs-height_25 cs-height_lg_25"></div>
            			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>手机短信</span> 
                <input type="text" name="reginfo[chkcode]"  placeholder="请输入短信验证码" required="">
				<button class="cs-btn cs-style1" type="button" value="获取验证码"  id="click_checkcode_phone">
                <span>取短信</span>                
              </button>
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
            <?php endif; if(sysconf('site_register_smscode_status')==1&&sysconf('site_register_code_type')=='email'): ?>
            <div class="cs-height_25 cs-height_lg_25"></div>
            <span class="cs-btn cs-style2 cs-btn_lg w-100">
                <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>邮箱验证码</span> 
                <input type="text" name="reginfo[chkcode]"  placeholder="请输入邮箱验证码" required="">
				<button class="cs-btn cs-style1" type="button" value="获取验证码"  id="click_checkcode_email">
                <span>取短信</span>                
              </button>
              </span>
            </span>
		  ...
		  <span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>登录密码</span> 
                <input type="password" id="password1" name="reginfo[password]"  placeholder="请输入密码"  required="">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>确认密码</span> 
                <input type="password" id="password2" name="reginfo[confirmpassword]"  placeholder="请输入确定密码"  required="">
              </span>
            </span>
            <div class="cs-height_25 cs-height_lg_25"></div>
			<span class="cs-btn cs-style2 cs-btn_lg w-100">
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>联系QQ</span> 
                <input type="text" id="newqq" name="reginfo[qq]"  placeholder="请输入QQ号" required="">
              </span>
            </span>
            ...
            <div class="cs-height_25 cs-height_lg_25"></div>
              ...
              <span class="text-left">
                <i class="fab fa-twitter"></i>
                <span>邀请码</span> 
                <input type="text" name="reginfo[invite_code]"  placeholder="邀请码<?php if(sysconf('is_need_invite_code')==1): ?>（必填）<?php else: ?>（选填）<?php endif; ?>">
                <?php if(sysconf('invite_code_get_url')!=""): ?>
                <button class="cs-btn cs-style1" type="button" value="获取邀请码"  id="get_invite_code">
                <span>去获取</span>                
                </button>
                <?php endif; ?>
                </span>
          ...
          <div class="text-center">
            ...
            <div class="custom-control custom-checkbox" data-toggle="tooltip" title="阅读并同意服务条款与协议">
              ...
              <div class="cs-height_25 cs-height_lg_25"></div>
            <button class="cs-btn cs-style1 cs-btn_lg" id="regBtn"><span>提 交 注 册</span></button>
          </div>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("#get_invite_code").click(function () {
                    ...
                    window.open("<?php echo sysconf('invite_code_get_url'); ?>");
                })
            })
            ...
            function send_sms() {
                ...
                $('.layui-layer-prompt .layui-layer-content').prepend($('<img style="cursor:pointer;height: 60px;" id="chkcode_img" src="https://www.611qk.com/index/user/verifycode.html?t=1681996142" onclick="javascript:this.src=\'/index/user/verifycode\'+\'?time=\'+Math.random()">'))
            }
