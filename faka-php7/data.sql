...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户端菜单' AUTO_INCREMENT=19 ;
...
CREATE TABLE IF NOT EXISTS `app_version` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客户端版本' AUTO_INCREMENT=1 ;
...
(4, 2, '1.怎么入驻自动发卡平台,成为商户?', '', '', '&lt;p&gt;通过平台的账户注册功能，即可免费入驻自动发卡平台。&lt;/p&gt;\r\n', 1, 0, 1520271835, 0, 0, 0),
(5, 2, '2.怎么登录自动发卡平台商户后台?', '', '', '&lt;p&gt;点此右上角&amp;ldquo;登录&amp;rdquo;按钮进入&lt;/p&gt;\r\n', 1, 0, 1520271854, 0, 0, 0),
(6, 2, '3.怎么用平台销售虚拟商品？', '', '', '&lt;p&gt;商户通过后台可以添加商品，每个商品自动发卡平台都会分配一个购买链接，商户只要将这个链接发送给买家，买家付款后平台自动发货，即可完成交易。&lt;/p&gt;\r\n', 1, 0, 1520271993, 0, 0, 0),
(7, 2, '4.平台可以卖些什么？', '', '', '&lt;p&gt;虚拟商品(例如软件注册码，论坛帐号等等)，不可以卖实物（例如衣服，水果等等）。&lt;/p&gt;\r\n', 1, 0, 1520272006, 0, 0, 0),
(8, 2, '5.账户的金额满多少自动结算？', '', '', '&lt;p&gt;商户账户金额满100.00元，当天晚上12点后，系统自动帮您提现，财务将于第二天12点前结算到您预留的账户，不满100.00元可以申请手动提现。&lt;/p&gt;\r\n', 1, 0, 1520272019, 0, 0, 0),
(9, 2, '6.财务结算商户方式有那些？', '', '', '&lt;p&gt;支持支付宝、银行卡，后期我们还会增加微信结算。&lt;/p&gt;\r\n', 1, 0, 1520272029, 0, 0, 0),
(10, 2, '7.如果买家已经付款,但是他说没有收到卡密该怎么办？', '', '', '&lt;p&gt;请直接联系自动发卡平台客服QQ解决。&lt;/p&gt;\r\n', 1, 0, 1520272041, 0, 0, 0),
(11, 2, '8.自动发卡平台安全吗？', '', '', '&lt;p&gt;非常安全，自动发卡平台运用先进的安全技术保护用户在自动发卡平台账户中存储的个人信息、账户信息以及交易记录的安全。&lt;/p&gt;\r\n\r\n&lt;p&gt;自动发卡平台拥有完善的全监测系统，可以及时发现网站的非正常访问并做相应的安全响应。&lt;span style=&quot;display: none;&quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;\r\n', 1, 0, 1521202911, 0, 0, 0),
...
(14, 3, '企业资质', '', '', '&lt;img src=&quot;http://oqwrj8igk.bkt.clouddn.com/WX20180324-190756.png&quot;/&gt;', 1, 3, 1521889791, 0, 0, 0),
...
CREATE TABLE IF NOT EXISTS `auto_unfreeze` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='订单金额T+1日自动解冻表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `cash_channel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cash_channel_account` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='支付供应商' AUTO_INCREMENT=176 ;
...
(58, '支付宝扫码', 'AlipayScan', 0, '', '', '', '', '', '', '', '0.0300', '0.0000', '0.0040', 1, '0.00', '0.00', '', 'alipay_public_key:alipay_public_key|merchant_private_key:merchant_private_key|app_id:app_id|防封域名（可选）:refer', 0, 4, '[]', 0, 3, '', 2, 'charset=UTF-8', 'https://open.alipay.com/platform/homeRoleSelection.htm', 1, 0),
(59, '支付宝H5', 'AlipayWap', 0, '', '', '', '', '', '', '', '0.0300', '0.0000', '0.0040', 1, '0.00', '0.00', '', 'alipay_public_key:alipay_public_key|merchant_private_key:merchant_private_key|app_id:app_id|防封域名（可选）:refer', 0, 5, '[]', 0, 4, '', 1, 'charset=UTF-8', 'https://open.alipay.com/platform/homeRoleSelection.htm', 1, 0),
...
(71, '微信官方H5支付', 'WxpayH5', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', 'appid:appid|mch_id:mch_id|signkey:signkey|防封域名（可选）:refer', 0, 0, '[]', 0, 27, '', 0, '', '', 1, 0),
(72, '微信扫码', 'WxpayScan', 0, '', '', '', '', '', '', '', '0.0300', '0.0000', '0.0040', 1, '0.00', '0.00', '', 'appid:appid|mch_id:mch_id|signkey:signkey|notify_url:notify_url|防封域名（可选）:refer', 0, 6, '[]', 0, 1, '', 0, '', '', 1, 0),
(73, '12kaQQ钱包扫码', 'Ka12QqNative', 0, '', '', '', '', '', '', '', '0.0300', '0.0500', '0.0200', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 30, '12kaQQ钱包扫码', 1, '', '', 1, 0),
(74, '12kaQQ钱包wap', 'Ka12QqWap', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 31, '12kaQQ钱包wap', 2, '', '', 1, 0),
(75, '12ka网银快捷', 'Ka12QuickBank', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 32, '12ka网银快捷', 1, '', '', 1, 0),
(76, '12卡网银快捷WAP', 'Ka12QuickWap', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 33, '12卡网银快捷WAP', 1, '', '', 1, 0),
(77, '12ka支付宝扫码', 'Ka12AlipayScan', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 34, '12ka支付宝扫码', 2, '', '', 1, 0),
(78, '12ka支付宝wap', 'Ka12AlipayWap', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 35, '12ka支付宝wap', 0, '', '', 1, 0),
(79, '12ka微信扫码', 'Ka12WxScan', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 36, '12ka微信扫码', 2, '', '', 1, 0),
(80, '12ka微信wap', 'Ka12WxWap', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户编号:customerid|api秘钥:apikey|防封域名（可选）:refer', 0, 0, NULL, 0, 37, '12ka微信wap', 2, '', '', 1, 0),
(81, '15173QQ扫码支付', 'Lh15173QqPay', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', 'bargainor_id:bargainor_id|key:key|防封域名（可选）:refer', 0, 0, NULL, 0, 39, '15173QQ扫码支付', 0, '', '', 1, 0),
...
(84, '码支付支付宝扫码', 'CodePayAliScan', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '码支付ID:id|通信秘钥:key|防封域名（可选）:refer', 0, 0, '', 0, 41, '码支付支付宝扫码', 0, '', '', 1, 0),
...
(139, '牛支付支付宝扫码', 'NZFAliqrcode', 1, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '商户号:memberid|appid:appid|app 密钥:key|子商户 id(没有请留空):submchid|防封域名（可选）:refer|防封域名（可选）:refer', 0, 0, '[]', 0, 88, '牛支付支付宝扫码', 0, '', '', 1, 0),
...
(176, '小白支付支付宝', 'EpayAli', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '接口地址:apiurl|商户Id:pid|商户密钥:key', 0, 0, '[]', 0, 129, '支付宝', 0, '', '', 0, 0),
(177, '小白支付微信', 'EpayWx', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '接口地址:apiurl|商户Id:pid|商户密钥:key', 0, 0, '[]', 0, 130, '微信支付', 0, '', '', 0, 0),
(178, '小白支付QQ钱包', 'EpayQq', 0, '', '', '', '', '', '', '', '0.0000', '0.0000', '0.0000', 1, '0.00', '0.00', '', '接口地址:apiurl|商户Id:pid|商户密钥:key', 0, 0, '[]', 0, 131, 'QQ钱包支付', 0, '', '', 0, 0);
...
CREATE TABLE IF NOT EXISTS `complaint_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='投诉会话信息' AUTO_INCREMENT=1 ;
...
INSERT INTO `goods` (`id`, `user_id`, `cate_id`, `theme`, `sort`, `name`, `price`, `cost_price`, `wholesale_discount`, `wholesale_discount_list`, `limit_quantity`, `inventory_notify`, `inventory_notify_type`, `coupon_type`, `sold_notify`, `take_card_type`, `visit_type`, `visit_password`, `contact_limit`, `content`, `remark`, `status`, `create_at`, `is_freeze`, `sms_payer`, `delete_at`) VALUES
(1, 10001, 1, 'chiji', 0, '绝地求生卡密', '0.10', '0.00', 0, '[]', 1, 0, 1, 0, 0, 0, 0, '', 'default', '这个自动发卡系统的商品说明', '这个自动发卡系统的使用说明', 1, 1538990072, 0, 0, NULL),
(2, 10001, 1, 'wangzhe', 0, '王者卡密', '0.10', '0.00', 0, '[]', 1, 0, 1, 0, 0, 0, 0, '', 'default', '这个是自动发卡系统王者卡密的卡密说明', '这个是自动发卡系统王者卡密的使用说明', 1, 1538990308, 0, 0, NULL),
(3, 10001, 1, 'yinyangshi', 0, '阴阳师卡密', '0.10', '0.00', 0, '[]', 1, 0, 1, 0, 0, 0, 0, '', 'default', '这个是阴阳师卡密商品说明', '这个是阴阳师卡密使用说明', 1, 1538990374, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `goods_card` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
...
(1, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 2, 1538990090, NULL, 1538990812),
(2, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(3, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(4, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(5, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(6, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(7, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(8, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(9, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990090, NULL, NULL),
(10, 10001, 1, 'AAAAAAAAAAA', 'BBBBBBBBBBBB', 1, 1538990090, NULL, NULL),
(11, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(12, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(13, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(14, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(15, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(16, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(17, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(18, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(19, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(20, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(21, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(22, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(23, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(24, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(25, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(26, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(27, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(28, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(29, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(30, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBBAAAAAAAAAAA', 1, 1538990394, NULL, NULL),
(31, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(32, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(33, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(34, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(35, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(36, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(37, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(38, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(39, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(40, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990394, NULL, NULL),
(41, 10001, 2, 'AAAAAAAAAAA', 'BBBBBBBBBBBB', 1, 1538990394, NULL, NULL),
(42, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(43, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(44, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(45, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(46, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(47, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(48, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(49, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(50, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(51, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(52, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(53, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(54, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(55, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(56, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(57, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(58, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(59, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(60, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(61, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(62, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(63, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(64, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(65, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(66, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(67, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(68, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(69, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(70, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(71, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(72, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(73, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(74, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(75, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(76, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(77, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(78, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(79, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(80, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(81, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(82, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(83, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(84, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(85, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(86, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(87, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(88, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(89, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(90, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(91, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(92, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(93, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(94, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(95, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(96, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(97, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(98, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(99, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(100, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(101, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(102, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(103, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(104, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(105, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(106, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(107, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(108, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(109, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(110, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(111, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(112, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB\r', 1, 1538990414, NULL, NULL),
(113, 10001, 3, 'AAAAAAAAAAA', 'BBBBBBBBBBBB', 1, 1538990414, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `goods_coupon` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `merchant_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统操作日志表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `merchant_log`
--

INSERT INTO `merchant_log` (`id`, `ip`, `node`, `user_id`, `username`, `action`, `content`, `create_at`) VALUES
(1, '61.242.114.84', 'merchant/goodscategory/add', 10001, 'demo', '添加商品分类成功', '添加商品分类成功，ID:1，名称:游戏卡密', '2018-10-08 09:13:15'),
(2, '61.242.114.84', 'merchant/goods/add', 10001, 'demo', '添加商品成功', '添加商品成功，商品ID:1,名称:绝地求生卡密,价格:0.1,成本价:0', '2018-10-08 09:14:33'),
(3, '61.242.114.84', 'merchant/goodscard/add', 10001, 'demo', '成功添加卡密', '成功添加10张卡密', '2018-10-08 09:14:50'),
(4, '61.242.114.84', 'merchant/goods/add', 10001, 'demo', '添加商品成功', '添加商品成功，商品ID:2,名称:王者卡密,价格:0.1,成本价:0', '2018-10-08 09:18:29'),
(5, '61.242.114.84', 'merchant/goods/add', 10001, 'demo', '添加商品成功', '添加商品成功，商品ID:3,名称:阴阳师卡密,价格:0.1,成本价:0', '2018-10-08 09:19:34'),
(6, '61.242.114.84', 'merchant/goodscard/add', 10001, 'demo', '成功添加卡密', '成功添加31张卡密', '2018-10-08 09:19:54'),
(7, '61.242.114.84', 'merchant/goodscard/add', 10001, 'demo', '成功添加卡密', '成功添加72张卡密', '2018-10-08 09:20:15'),
(8, '61.242.114.84', 'index/user/dologin', 10001, 'demo', '登录成功', '登录成功', '2018-10-08 09:22:23');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='前台导航表' AUTO_INCREMENT=8 ;
...
(1, 0, '网站首页', '', '', '/', '', '0', 10, 1, 0, '2018-03-23 01:20:50'),
(2, 0, '常见问题', '', '', '/company/faq', '', '0', 3, 1, 0, '2018-03-23 01:21:11'),
(3, 0, '联系我们', '', '', '/company/contact', '', '0', 4, 1, 0, '2018-03-23 01:21:35'),
(4, 0, '订单查询', '', '', '/orderquery', '', '0', 0, 1, 0, '2018-03-23 01:22:09'),
(5, 0, '企业资质', '', '', '/article/14.html', '', '1', 0, 1, 0, '2018-03-23 03:28:55'),
(6, 0, '用户注册', '', '', '/register', '', '1', 0, 1, 0, '2018-05-10 04:24:37'),
(7, 0, '投诉查询', '', '', '/complaintquery', '', '_self', 0, 1, 0, '2018-06-21 02:53:00');
...
CREATE TABLE IF NOT EXISTS `pay_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='支付类型表' AUTO_INCREMENT=129 ;
...
(1, '微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(2, '微信H5', 2, 'icon_wx', 'icon_wx', 1, 0, 0, NULL),
(3, '支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(4, '支付宝H5', 1, 'icon_zfb', 'icon_zfb', 1, 0, 0, NULL),
(5, '网银跳转', 6, 'icon_bank', 'icon_bank', 0, 0, 0, NULL),
(6, '网银直连', 6, 'icon_bank', 'icon_bank', 0, 0, 0, NULL),
(7, '百度钱包', 5, 'baidu_logo', 'baidu_ico', 0, 0, 0, NULL),
(8, 'QQ钱包扫码', 3, 'qqrcode', 'qqrcode', 0, 0, 0, NULL),
(9, '京东钱包', 4, 'jd_logo', 'jd_ico', 0, 0, 0, NULL),
(10, 'QQ钱包H5', 3, 'icon_qq', 'icon_qq', 1, 0, 0, NULL),
(11, '支付宝PC', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(12, '微信刷卡', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(13, '支付宝刷卡', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(14, '支付宝免签', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(15, '微信免签', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(16, '微极速微信支付', 2, 'icon_wx', 'icon_wx', 1, 1, 0, NULL),
(17, '15173PC微信支付', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(18, '15173Wap微信支付', 2, 'icon_wx', 'icon_wx', 1, 0, 0, NULL),
(19, '拉卡微信扫码支付', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(20, '拉卡微信h5支付', 2, 'icon_wx', 'icon_wx', 1, 0, 0, NULL),
(21, '拉卡支付宝扫码支付', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(22, '快接微信扫码支付', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(23, '快接微信H5支付', 2, 'icon_wx', 'icon_wx', 1, 0, 0, NULL),
(24, '快接支付宝扫码支付', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(25, '快接支付宝扫码支付(线上二维码)', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(26, '快接支付宝H5支付', 1, 'icon_zfb', 'icon_zfb', 1, 0, 0, NULL),
(27, '微信官方H5支付', 2, 'icon_wx', 'icon_wx', 1, 0, 0, NULL),
(28, '拉卡QQ支付', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
...
(30, '12kaQQ钱包扫码', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(31, '12kaQQWap', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(32, '12ka网银快捷', 6, 'icon_bank', 'icon_bank', 0, 0, 0, NULL),
(33, '12ka网银Wap', 6, 'icon_bank', 'icon_bank', 0, 0, 0, NULL),
(34, '12ka支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(35, '12ka支付宝wap', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(36, '12ka微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(37, '12ka微信wap', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(38, '码支付微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(39, '15173Qq扫码支付', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(40, '码支付QQ扫码', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(41, '码支付支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(42, '蜂鸟支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(43, '蜂鸟支付宝WAP', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(44, '蜂鸟微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(45, '蜂鸟微信公众号支付', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(46, '蜂鸟QQ钱包扫码', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(47, '掌灵付微信扫码', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(48, '掌灵付QQ扫码', 3, 'qqrcode', 'qqrcode', 0, 1, 0, NULL),
(49, '掌灵付支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(50, '掌灵付微信公众号支付', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(51, '黔贵金服支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(52, '黔贵金服微信扫码', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(53, '黔贵金服QQ扫码', 3, 'qqrcode', 'qqrcode', 0, 1, 0, NULL),
(54, '黔贵金服微信公众号支付', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(55, '黔贵金服支付宝Wap', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(56, '黔贵金服微信WAP', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(57, '点缀支付宝即时到账', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(58, '点缀支付京东钱包扫码', 4, 'icon_jd', 'icon_jd', 0, 0, 0, NULL),
(59, '掌灵付微信H5', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(60, '掌灵付京东H5', 4, 'icon_jd', 'icon_jd', 0, 0, 0, NULL),
(61, '点缀微信 H5', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(62, '优畅上海微信 H5', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(63, '优畅上海微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(64, '优畅上海微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(65, 'Topay微信', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(66, 'Topay 支付宝', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(67, '海鸟微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(68, '海鸟微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(69, '海鸟微信 H5', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(70, '海鸟 QQ 扫码', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(71, '海鸟支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(72, '淘米支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(73, '淘米微信扫码', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(74, '淘米QQ扫码', 3, 'qqrcode', 'qqrcode', 0, 1, 0, NULL),
(75, '淘米微信公众号支付', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(76, '淘米支付宝Wap', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(77, '淘米微信WAP', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(78, '完美数卡微信扫码', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(79, '完美数卡支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(80, '完美数卡QQ扫码', 3, 'icon_qq', 'icon_qq', 0, 1, 0, NULL),
(81, '完美数卡QQWap', 3, 'icon_qq', 'icon_qq', 0, 1, 0, NULL),
(82, '完美数卡微信Wap', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(83, '完美数卡支付宝Wap', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(84, '支付宝免签', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(85, 'qq免签', 3, 'icon_qq', 'icon_qq', 0, 1, 0, NULL),
(86, '微信免签', 2, 'icon_wx', 'icon_wx', 0, 1, 0, NULL),
(87, '掌灵付支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(88, '牛支付支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 1, 0, NULL),
(89, '掌灵付京东扫码', 4, 'icon_jd', 'icon_jd', 0, 0, 0, NULL),
(90, '优畅上海支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(91, '优畅上海支付宝 Wap', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(92, '威富通支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(93, '威富通支付宝Wap', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(94, '威富通微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(95, '威富通京东扫码', 4, 'icon_jd', 'icon_jd', 0, 0, 0, NULL),
(96, '威富通微信wap', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(97, '威富通微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(98, '汉口银行微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(99, '汉口银行微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(100, '汉口银行微信wap', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(101, '汉口银行支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(102, '汉口银行支付宝Wap', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(103, '优畅上海QQ扫码', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(104, '优畅上海QQWap', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL),
(105, '平安付微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(106, '平安付支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(107, '平安付支付宝wap', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(108, '平安付微信wap', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(109, '网商银行微信', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(110, '网商银行支付宝', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(111, '吉易支付微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(112, '吉易支付微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(113, 'PayApi支付宝', 2, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(114, 'PayApi微信', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(115, '易云支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(116, '易云支付宝WAP', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(117, '易云微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(118, '易云微信WAP', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(119, '易云微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(120, '恒隆支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(121, '恒隆支付宝WAP', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(122, '恒隆微信公众号支付', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(123, '恒隆微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(124, '深度支付宝扫码', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(125, '深度支付宝服务窗支付', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(126, '深度微信扫码', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(127, '深度微信公众号', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(128, '聚合支付', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(129, '彩虹易支付支付宝', 1, 'icon_zfb', 'icon_zfb', 0, 0, 0, NULL),
(130, '彩虹易支付微信', 2, 'icon_wx', 'icon_wx', 0, 0, 0, NULL),
(131, '彩虹易支付QQ钱包', 3, 'icon_qq', 'icon_qq', 0, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `rate_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(20) NOT NULL COMMENT '分组名',
  `create_at` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `delete_at` int(10) unsigned DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='费率分组表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rate_group_rule` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分组费率规则' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `rate_group_user` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL COMMENT '分组 ID',
  `user_id` int(11) NOT NULL COMMENT '用户 ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分组内用户表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统权限表' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统参数配置' AUTO_INCREMENT=312 ;
...
(148, 'site_name', '自动发卡平台'),
(149, 'site_copy', '自动发卡平台 © 2014~2018 版权'),
...
(209, 'alidayu_secret', 'dalidayu_secret'),
(210, 'alidayu_smstpl', 'SMS_111795375'),
(211, 'alidayu_signature', '自动发卡'),
(212, 'yixin_sms_user', 'Daniel'),
(213, 'yixin_sms_pass', 'AAA14712345678'),
(214, 'yixin_sms_signature', '自动发卡'),
(215, 'email_name', '自动发卡'),
(216, 'email_smtp', 'smtp.qq.com'),
(217, 'email_port', '465'),
(218, 'email_user', '562854011@qq.com'),
(219, 'email_pass', 'wtyifjljjgtnbcja'),
(220, 'cash_min_money', '100'),
(221, 'transaction_min_fee', '0.01'),
(222, 'cash_fee_type', '100'),
(223, 'cash_fee', '2'),
(224, 'spread_rebate_rate', '0.3'),
(225, 'site_keywords', '自动发卡平台,发卡平台,自动发卡,弈新自动发卡平台'),
(226, 'site_desc', '极受用户欢迎的自动发卡平台，满50元结算无手续费，自动发卡平台支持APP管理、提供API接口、微信公众号在线管理！'),
(227, 'site_status', '1'),
(228, 'site_subtitle', '【24小时稳定提供自动发卡服务】'),
...
(237, 'site_info_tel', '131-1234-5678'),
(238, 'site_info_qq', '12344321'),
(239, 'site_info_address', '广州市海珠区琶洲'),
(240, 'site_info_email', '12345678@qq.com'),
(241, 'site_info_copyright', 'Copyright © 2018-2020 自动发卡系统 All rights reserved. 版权所有'),
(242, 'site_info_icp', '粤ICP备：12345678号'),
(243, 'site_domain', 'https://ka.tianniu.cc'),
...
(273, 'site_statistics', '&lt;script src=&quot;https://s4.cnzz.com/z_stat.php?id=1261189048&amp;web_id=1261189048&quot; language=&quot;JavaScript&quot;&gt;&lt;/script&gt;&lt;a target=&quot;_blank&quot; href=&quot;https://v.pinpaibao.com.cn/cert/site/?site=www.vipkm.com&amp;at=realname&quot; &gt;&lt;img src=&quot;https://static.anquan.org/static/outer/image/sm_83x30.png&quot;&gt;&lt;/img&gt;&lt;/a&gt;'),
...
CREATE TABLE IF NOT EXISTS `system_log` (
  ...
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统操作日志表' AUTO_INCREMENT=35 ;
...
(1, '61.242.114.84', 'admin/login/index', 'demouser', '系统管理', '用户登录系统成功', '2018-10-08 09:08:28'),
(2, '61.242.114.84', 'admin/login/out', 'admin', '系统管理', '用户退出系统成功', '2018-10-08 09:09:27'),
(3, '61.242.114.84', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-10-08 09:09:58'),
(4, '61.242.114.84', 'manage/user/add', 'admin', '用户管理', '添加商户成功，商户ID:10001', '2018-10-08 09:12:45'),
(5, '61.242.114.84', 'manage/user/login', 'admin', '用户管理', '登录商户平台成功，商户ID:10001', '2018-10-08 09:12:49'),
(6, '61.242.114.84', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2018-10-08 09:14:28'),
(7, '61.242.114.84', 'manage/site/domain', 'admin', '系统管理', '修改域名设置成功', '2018-10-08 09:16:13'),
(8, '61.242.114.84', 'manage/site/domain', 'admin', '系统管理', '修改域名设置成功', '2018-10-08 09:16:21'),
(9, '61.242.114.84', 'manage/channel/change_status', 'admin', '网关通道', '成功关闭接口，ID:98', '2018-10-08 09:23:04'),
(10, '61.242.114.84', 'manage/channel/change_status', 'admin', '网关通道', '成功关闭接口，ID:94', '2018-10-08 09:23:09'),
(11, '61.242.114.84', 'manage/channel/change_status', 'admin', '网关通道', '成功关闭接口，ID:95', '2018-10-08 09:23:13'),
(12, '61.242.114.84', 'manage/channel/change_status', 'admin', '网关通道', '成功关闭接口，ID:96', '2018-10-08 09:23:17'),
(13, '61.242.114.84', 'manage/channel/change_status', 'admin', '网关通道', '成功开启接口，ID:139', '2018-10-08 09:25:04'),
(14, '61.242.114.84', 'manage/channelaccount/add', 'admin', '网关通道', '添加接口账号成功，ID:{"name":"演示账号","rate_type":0,"status":1,"params":{"memberid":"2","appid":"12340004","key":"0e0a47c54df24e3015eb78475bfae915","submchid":"","refer":""},"channel_id":139,"id":"1"}', '2018-10-08 09:26:22'),
(15, '61.242.114.84', 'manage/user/login', 'admin', '用户管理', '登录商户平台成功，商户ID:10001', '2018-10-08 09:31:28'),
(16, '113.200.140.114', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-02-15 14:32:07'),
(17, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 14:32:55'),
(18, '113.134.39.75', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-02-15 15:10:24'),
(19, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 15:11:32'),
(20, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 15:12:00'),
(21, '113.134.39.75', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 15:27:42'),
(22, '113.134.39.75', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 15:28:14'),
(23, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 15:47:22'),
(24, '113.134.39.75', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 16:05:32'),
(25, '113.134.39.75', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 16:06:23'),
(26, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 16:07:59'),
(27, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 16:09:02'),
(28, '113.200.140.114', 'admin/config/index', 'admin', '系统管理', '系统参数配置成功', '2019-02-15 16:10:17'),
(29, '113.200.140.114', 'manage/site/register', 'admin', '系统管理', '修改注册设置成功', '2019-02-15 16:12:38'),
(30, '113.134.39.75', 'manage/site/register', 'admin', '系统管理', '修改注册设置成功', '2019-02-15 16:13:04'),
(31, '113.134.39.75', 'manage/site/register', 'admin', '系统管理', '修改注册设置成功', '2019-02-15 16:13:44'),
(32, '106.111.218.115', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-02-17 12:59:49'),
(33, '106.111.218.115', 'manage/user/login', 'admin', '用户管理', '登录商户平台成功，商户ID:10001', '2019-02-17 13:10:33'),
(34, '194.156.231.124', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-02-28 14:52:53');
...
CREATE TABLE IF NOT EXISTS `system_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_system_menu_node` (`node`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统菜单表' AUTO_INCREMENT=136 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统节点表' AUTO_INCREMENT=318 ;
...
(307, 'manage/goods/change_trade_no_status', NULL, 0, 1, 1, '2018-04-19 17:04:48'),
(308, 'shop/shop/index', NULL, 0, 0, 0, '2018-06-21 02:19:27'),
(309, 'shop/shop/category', NULL, 0, 0, 0, '2018-06-21 02:19:28'),
(310, 'shop/shop/goods', NULL, 0, 0, 0, '2018-06-21 02:20:39'),
(311, 'shop/shop/getgoodslist', NULL, 0, 0, 0, '2018-06-21 02:20:40'),
(312, 'shop/shop/getgoodsinfo', NULL, 0, 0, 0, '2018-06-21 02:20:41'),
(313, 'shop/shop/getrate', NULL, 0, 0, 0, '2018-06-21 02:20:41'),
(314, 'shop/shop/getdiscounts', NULL, 0, 0, 0, '2018-06-21 02:20:42'),
(315, 'shop/shop/getdiscount', NULL, 0, 0, 0, '2018-06-21 02:20:43'),
(316, 'shop/shop/checkvisitpassword', NULL, 0, 0, 0, '2018-06-21 02:20:43'),
(317, 'shop/shop/checkcoupon', NULL, 0, 0, 0, '2018-06-21 02:20:44');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统用户表' AUTO_INCREMENT=10006 ;
...
(10005, 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, '12345678@qq.com', '13800138000', 'demo', 260, '2019-02-28 22:52:53', 1, '3', 0, NULL, '2018-05-02 00:40:09', NULL);
...
CREATE TABLE IF NOT EXISTS `unique_orderno` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(10001, 0, '', 'demo', '25d55ad283aa400af464c76d713c07ad', '13800138000', '5021314', 'demo@qq.com', '', '', '', '', 'default', 2, '0.000', '0.000', '0.090', 1, 0, 1538989965, '', '', 0, 1, 1, 0, 1, '', 1, 1, 0, 0, -1);
...
CREATE TABLE IF NOT EXISTS `user_login_error_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `user_money_log`
--

INSERT INTO `user_money_log` (`id`, `business_type`, `user_id`, `money`, `balance`, `reason`, `create_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `verify_email_error_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `verify_error_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) DEFAULT '' COMMENT '前台用户名',
  `admin` varchar(50) DEFAULT '' COMMENT '管理员用户名',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='支付日志表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='支付订单号对应表' AUTO_INCREMENT=1 ;
