...
<div class="form-group">
<label>商品图片:</label><br>
<input type="text" class="form-control" name="shopimg" value="" placeholder="请输入图片外链">
</div>
<div class="form-group">
...
<div class="form-group">
<label>商品图片:</label><br>
<input type="text" class="form-control" name="shopimg" value="';
    echo $row['shopimg'];
    echo '" placeholder="请输入图片外链">
</div>
<div class="form-group">
<label>显示数量选择框:</label><br>
...
';
    ...
    if (($name==NULL || $price==NULL)) {
        ...
        $sql = 'INSERT INTO `shua_tools` (`cid`,`name`,`price`,`cost`,`cost2`,`input`,`shopimg`,`inputs`,`alert`,`value`,`is_curl`,`curl`,`shequ`,`goods_id`,`goods_type`,`goods_param`,`repeat`,`multi`,`validate`,`sort`,`active`) VALUES (\'' . $cid . '\',\'' . $name . '\',\'' . $price . '\',\'' . $cost . '\',\'' . $cost2 . '\',\'' . $input . '\',\'' . $shopimg . '\',\'' . $inputs . '\',\'' . $alert . '\',\'' . $value . '\',\'' . $is_curl . '\',\'' . $curl . '\',\'' . $shequ . '\',\'' . $goods_id . '\',\'' . $goods_type . '\',\'' . $goods_param . '\',\'' . $repeat . '\',\'' . $multi . '\',\'' . $validate . '\',\'' . $sort . '\',\'1\')';
    ...
    if (($name==NULL || $price==NULL)) {
        ...
        showmsg('请选择对接社区！', 3);
    } elseif ($DB->query('UPDATE `shua_tools` SET `cid`=\'' . $cid . '\',`name`=\'' . $name . '\',`price`=\'' . $price . '\',`cost`=\'' . $cost . '\',`cost2`=\'' . $cost2 . '\',`input`=\'' . $input . '\',`shopimg`=\'' . $shopimg . '\',`inputs`=\'' . $inputs . '\',`alert`=\'' . $alert . '\',`value`=\'' . $value . '\',`is_curl`=\'' . $is_curl . '\',`curl`=\'' . $curl . '\',`shequ`=\'' . $shequ . '\',`goods_id`=\'' . $goods_id . '\',`goods_type`=\'' . $goods_type . '\',`goods_param`=\'' . $goods_param . '\',`repeat`=\'' . $repeat . '\',`multi`=\'' . $multi . '\',`validate`=\'' . $validate . '\' WHERE `tid`=\'' . $tid . '\'')) {
