	...
	<div class="block" style="min-height: 310px;">
		...
		<div class="tab-pane fade fade-up in active" id="onlinebuy">
			...
			<div class="form-group" id="display_num" style="display:none;">
				<div class="input-group"><div class="input-group-addon">下单数量</div>
				<span class="input-group-btn"><input id="num_min" type="button" class="btn btn-primary" style="border-radius: 0px;" value="－"/></span>
				<input id="num" name="num" class="form-control" type="number" min="1" value="1"/>
				<span class="input-group-btn"><input id="num_add" type="button" class="btn btn-primary" style="border-radius: 0px;" value="＋"/></span>
			</div></div>
			<div class="form-group">
...
<div class="col-xs-3">
<h5 class="widget-heading"><small>累计交易额</small><br><a href="javascript:void(0)" class="themed-color-flat"><span id="count_money"></span>天</a></h5>
</div>
<div class="col-xs-3">
<h5 class="widget-heading"><small>今日交易额</small><br><a href="javascript:void(0)" class="themed-color-flat"><span id="count_money1"></span>天</a></h5>
</div>
</div>
</div>
